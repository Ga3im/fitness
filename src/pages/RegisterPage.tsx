    ...
    <div className="w-screen h-screen flex justify-center items-center z-1 bg-[rgb(0,0,0,0.2)] absolute">
      <div className="mx-[16px] fixed rounded-[30px] pb-[40px] pl-[40px] pt-[10px] pr-[10px] bg-white">
        ...
        <div className="flex flex-col mr-[30px]">
          <Logo />
          <div className="pt-[20px] pb-[5px] flex flex-col gap-[10px]">
            <input
              ref={nameRef}
              className={
                error === "Введите имя"
          ...
          {error && (
            <p className="text-[#DB0030] place-self-center text-center">
              {error}
            </p>
          )}
          ...
          <button
            ...
            className={
              isLoading
                ? "text-[16px] rounded-[45px] bg-[#F7F7F7] text-[#999999] px-[16px] py-[5px] mb-[10px] mt-[20px]"
                : "text-[16px] rounded-[45px] bg-[#BCEC30] hover:bg-[#C6FF00] active:bg-[#A0B000] active:text-[white] px-[16px] py-[5px] mb-[10px] mt-[20px]"
            }
          >
            Зарегистрироваться
          </button>
          ...
          <button
            ...
            className="text-[16px] rounded-[45px] bg-white px-[16px] py-[5px] border-1"
          >
            Войти
          </button>
        </div>
